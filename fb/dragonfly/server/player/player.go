...
import (
	...
	blockAction "phoenixbuilder_3rd_gui/fb/dragonfly/server/block/action"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/block/cube"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/cmd"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/entity"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/entity/action"
	...
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/event"
	...
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/item/inventory"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/item/tool"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/player/bossbar"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/player/chat"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/player/form"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/player/scoreboard"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/player/skin"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/player/title"
	"phoenixbuilder_3rd_gui/fb/dragonfly/server/session"
